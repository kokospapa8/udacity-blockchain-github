...
contract StarNotary is ERC721 {
    ...
    string public constant name = "KOKOS PAPA TOKEN";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        //1. Passing to star tokenId you will need to 
        ...
        //TODO
        require(ownerAddress1 == msg.sender || ownerAddress2 == msg.sender, "You need to own one of stars");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerOf(_tokenId), "Sender is not the owner of the star");
